...
searchEl.addEventListener("input", (0, _lodashDebounceDefault.default)(newValue, DEBOUNCE_DELAY));
...
function newValue() {
    ...
    if (findCountryName === "") {
        clearEl();
        return;
    } else (0, _fetchCountriesJs.fetchCountries)(findCountryName).then((countryNames)=>{
...
function makeNewCard([land]) {
    clearEl();
    const { name: { official  } , flags: { svg  } , capital , population , languages ,  } = land;
...
},{"./css/styles.css":"1CY4s","./fetchCountries.js":"fTQqv","lodash.debounce":"3JP5n","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"fTQqv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchCountries", ()=>fetchCountries);
function fetchCountries(query) {
    return fetch(`https://restcountries.com/v3.1/name/${query}`).then((response)=>{
